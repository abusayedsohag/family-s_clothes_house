...
const Banner = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const data = { image, title, startDate: sdate || todate, expireDate: edate || null };
    ...
    return (
        <div>
            <div className=''>
                ...
                <hr />
                <div className='grid md:grid-cols-2 px-0 p-2 md:p-10 gap-10'>
...

                    {
                        edit && (
                            <form onSubmit={(e) => handleUpdate(e, edit._id)} className=' flex flex-col gap-3'>
                                ...
                                <input type="text" required name="title" className='input input-info w-full outline-0' defaultValue={edit.title} placeholder='Type Your Banner Title' />
