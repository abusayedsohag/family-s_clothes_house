            ...
            <div className='flex justify-between items-center'>
                ...
                <div className='flex gap-2'>
                    <div className="dropdown">
                        <div tabIndex={0} role="button" className="btn m-1 btn-dash btn-xs md:btn-sm">
                    ...
                    <a href='/admin/products/add' tabIndex={0} role="button" className="btn m-1 btn-xs md:btn-sm btn-primary">
